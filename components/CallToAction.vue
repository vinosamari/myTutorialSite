...
<style scoped>
.ctaWrapper {
  @apply w-1/2 h-auto p-10 flex flex-col gap-2 bg-mainThree rounded-md text-center shadow-2xl bg-opacity-30 text-gray-200 hover:bg-opacity-70 transition-all duration-500;
}

.heroHeader {
  @apply text-3xl tracking-widest mb-4 font-bold;
}
